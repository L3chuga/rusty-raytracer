...
const LEFT_MATERIAL : Material = Material::Lambertian { albedo: Color::new(0.4,0.2,0.1) };
const CENTER_MATERIAL : Material = Material::Dielectric { refraction_index: 1.5 };
const RIGHT_MATERIAL : Material = Material::Metal { albedo: Color::new(0.7,0.6,0.5), fuzz: 0.0 };
...
const S3 : Sphere = Sphere::new(Vec3::new(4.0,1.0,0.0),1.0, RIGHT_MATERIAL);
